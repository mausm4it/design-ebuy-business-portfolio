...
Route::get('/contact_form', function(){
    return view('emails.receive_contact');
});
...
Route::middleware(['XSS'])->group(function () {
    ...
    Route::get('portfolio/category2/{category_name}', [App\Http\Controllers\Frontend\PortfolioController::class, 'category_show2'])
        ->name('portfolio-category2.show');
