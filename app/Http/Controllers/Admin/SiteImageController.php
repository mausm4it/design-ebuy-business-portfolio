...
class SiteImageController extends Controller
{
    ...
    public function store(Request $request)
    {
        // Form validation
        $request->validate([
            'favicon_image' => 'mimes:svg,png,jpeg,jpg',
            'admin_logo_image' => 'mimes:svg,png,jpeg,jpg',
            'admin_small_logo_image' => 'mimes:svg,png,jpeg,jpg',
            'site_white_logo_image' => 'mimes:svg,png,jpeg,jpg',
            'site_colored_logo_image' => 'mimes:svg,png,jpeg,jpg',
        ]);
