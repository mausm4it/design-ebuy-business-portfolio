...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $services_all= ServiceSection::all();
        ...
        $portfoliox= PortfolioCategory::all();
      


        return view('frontend.home.index', compact('site_info', 'google_analytic', 'socials', 'color_option','portfoliox',
            'homepage_version', 'fixed_content', 'about', 'info_lists', 'feature_section', 'features',
            'service_section', 'services', 'counter_section', 'services_all', 'counters', 'work_process_section', 'work_processes',
