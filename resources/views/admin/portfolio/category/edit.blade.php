    ...
    <div class="row">
        <div class="col-xl-12 box-margin height-card">
            ...
            @if ($demo_mode == "on")
                ...
                @else
                    <form action="{{ route('portfolio-category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input  name="category_image" type="file" class="form-control-file" value="{{ $category->category_image }}" >
