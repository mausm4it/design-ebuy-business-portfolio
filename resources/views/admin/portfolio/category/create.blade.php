                        ...
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td><img src="{{asset('uploads/img/porfoliocategory/'.$category->category_image)}}" height="100" width="100"></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input  name="category_image" type="file" class="form-control-file" >
