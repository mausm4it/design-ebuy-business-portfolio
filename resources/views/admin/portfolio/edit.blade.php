                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input  name="lnk_button_name" type="text" class="form-control-file" value="{{ $portfolio->lnk_button_name }}">
                                  ...
                                  <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input  name="lnk_button_link" type="text" class="form-control-file" value="{{ $portfolio->lnk_button_link }}">
                                ...
                                <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="post_type">
                                                <option value="{{$portfolio->post_type}}" selected>
                                                    Works
                                                </option>
