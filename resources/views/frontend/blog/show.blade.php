...
@section('content')
    ...
    <section class="breadcrumb-section section d-none d-xl-block" data-scroll-index="1" @if ($blog->breadcrumb_status == 1 && !empty($blog->custom_breadcrumb_image))  data-bg-image-path = "{{ asset('uploads/img/blogs/breadcrumb/'.$blog->custom_breadcrumb_image) }}"
